...
public class AdminCommands {
    ...
    public void kill(GuildMessageReceivedEvent event, ArgumentTranslator translator) {
    ...
    public void restart(GuildMessageReceivedEvent event, ArgumentTranslator translator) {
    ...
    public void setPrefix(GuildMessageReceivedEvent event, ArgumentTranslator translator) {
